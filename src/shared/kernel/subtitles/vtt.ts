...
export type VTTTimestampDefault =
  `${string}${Separators['PARTS']}${string}${Separators['PARTS']}${string}${Separators['MS']}${string}`;

export type VTTTimestampRangeTemplate<Timestamp extends string> =
  `${Timestamp}${Separators['RANGE']}${Timestamp}`;
